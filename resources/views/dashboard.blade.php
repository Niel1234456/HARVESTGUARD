    ...
    <div class="left-section">
        <div class="summary-cards">
            ...
            <div class="card high equipment-card">
                ...
                <p><b><i class="fas fa-tools"></i>{{ $totalEquipment }}</b></p>
                <b><a href="{{ route('admin.insight.index') }}" class="view-more">view more</a></b>
            </div>
            
            <!-- Available Supplies -->
            <div class="card high supplies-card">
                <h3>Available Supplies</h3>
                <p><b><i class="fas fa-boxes"></i>{{ $totalSupplies }}</b></p>
                <b><a href="{{ route('admin.insight.index') }}" class="view-more">view more</a></b>
            </div>
        </div>
        ...
        <h4>REGISTERED FARMERS</h4>
            <div class="recent-farmers">                <div class="farmers-list">
                    @foreach($recentFarmers as $farmer)
                    <div class="farmer-card">
                        <img src="{{ $farmer->profile_picture ? asset('images/profile_pictures/' . $farmer->profile_picture) : asset('images/default-profile.png') }}" alt="Profile Picture" class="profile-pic">
                        <p>
                            <a href="{{ route('admin.admin.farmers', ['id' => $farmer->id]) }}">
                                <b>{{ $farmer->first_name }}</b>
                            </a>
                        </p>
                    </div>
                    @endforeach
